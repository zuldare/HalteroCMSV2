...
create table categories (category_id integer generated by default as identity, active boolean, description varchar(255), downLimit double not null, gender varchar(255), name varchar(255), upLimit double not null, primary key (category_id))
